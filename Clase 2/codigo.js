...
console.log(nombre);
// console.log(numero); Error: La variable no esta definida de manera global.

let texto1 = "Curso programacion Backend"
console.log(texto1);
texto1 = 'Curso Programacion Backend - Docente : \n\t' + nombre;
console.log(texto1);
texto1 = `Curso programacion Backend - Docente      ${nombre}`
console.log(texto1);
